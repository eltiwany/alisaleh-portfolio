...
<!-- Mirrored from ixtheme.netlify.app/zuman/all-works.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Jan 2022 06:43:33 GMT -->
...
<body id="top" data-spy="scroll" data-target="#menu_items">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-8">
                    <div class="logo">
                        <a href="index-2.html"><img src="img/logo.png" alt="zuman"></a>
                    </div>
                </div>
                <div class="col-md-9 col-4">
                    <div class="back_to_home">
                        <a href="index-2.html"><i class="ion-android-arrow-back"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <!-- start work wrapper -->
                <div id="works" class="work_wrapper work_wrapper_page">
                            ...
                            <div class="row works">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 uiux">
                                    <div class="work_single_item">
                                        ...
                                        <div class="work_info">
                                            <h6 title="Black &amp; White Shoe">Black &amp; White Shoe</h6>
                                            <p>Upcoming</p>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 web">
                                    <div class="work_single_item">
                                        ...
                                        <div class="work_info">
                                            <h6 title="White Lamp in White Wall">White Lamp in White Wall</h6>
                                            <p>05 Aug 2018</p>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 branding">
                                    <div class="work_single_item">
                                        ...
                                        <div class="work_info">
                                            <h6 title="Green Lamp Holder">LED Torch Light</h6>
                                            <p>21 July 2018</p>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 web">
                                    <div class="work_single_item">
                                        ...
                                        <div class="work_info">
                                            <h6 title="Green Lamp Holder">Green Lamp Holder</h6>
                                            <p>16 June 2018</p>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 branding">
                                    <div class="work_single_item">
                                        ...
                                        <div class="work_info">
                                            <h6 title="Olive Oil Bottle">Stainless Steel Chair</h6>
                                            <p>19 April 2018</p>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 uiux">
                                    <div class="work_single_item">
                                        ...
                                        <div class="work_info">
                                            <h6 title="Black Chair">Black Chair</h6>
                                            <p>27 Feb 2018</p>
                                ...
                                <div class="col-lg-12">
                                    <a class="button slide-vertical" data-splitting href="all-works.html">Next Page</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <footer>
                    ...
                    <p class="copyright">&copy; <span><a href="https://nafuutronics.com" target="_blank" rel="noopener noreferrer">Nafuutronics</a></span>. All Rights Reserved.</p>
                </footer>
                <!-- end footer wrapper -->
            </div>
        </div>
